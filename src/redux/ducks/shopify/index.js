...
const CHANGE_MODAL_STATUS = 'shopify/CHANGE_MODAL_STATUS';
...
const initialState = {
    ...
    product: {},
    shop: {},
    menuText: ['Home', 'About', 'Cart', 'Contact'],
    modalStatus: false,
    // home_images: ["home_original.png", "home_select.png", "home_used.png"].map((i) => IMAGE_PATH+i)
};
...
export function useShopify() {
    ...
    const menuText = useSelector((appState) => appState.shopifyState.menuText);
    const modalStatus = useSelector((appState) => appState.shopifyState.modalStatus);
    ...
    const changeModalStatus = (count) => dispatch(handleChangeModalStatus());
